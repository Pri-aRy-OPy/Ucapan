...
import { storage, db } from '../firebase/config'; // Corrected Path
        ...
        <div className="min-h-screen bg-gradient-to-br from-blue-100 to-purple-200 flex flex-col justify-center items-center p-4">
            ...
            <div className="w-full max-w-md bg-white rounded-2xl shadow-2xl p-8 text-center">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    <input type="text" value={name} onChange={(e) => setName(e.target.value)} placeholder="Nama yang berulang tahun" className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400" required />
                    ...
                    <button type="submit" disabled={loading} className="w-full bg-gradient-to-r from-blue-500 to-purple-500 text-white font-bold py-3 px-4 rounded-lg hover:from-blue-600 hover:to-purple-600 shadow-lg disabled:opacity-50 flex justify-center items-center">
